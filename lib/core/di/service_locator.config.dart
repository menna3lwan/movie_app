...
import '../../features/details/data/api/details_api.dart' as _i642;
import '../../features/details/data/api/similar_api.dart' as _i947;
...
import '../../features/details/presentation/view_model/details_cubit.dart'
    as _i262;
import '../../features/home/data/API/popular_api.dart' as _i236;
import '../../features/home/data/API/releases_api.dart' as _i117;
import '../../features/home/data/API/top_rated_api.dart' as _i362;
import '../../features/home/data/repository/data_source/popular_data_source_imp.dart'
    as _i467;
import '../../features/home/data/repository/data_source/releases_data_source_imp.dart'
    as _i81;
import '../../features/home/data/repository/data_source/top_rated_data_source_imp.dart'
    as _i1041;
import '../../features/home/data/repository/repository/popular_repo_imp.dart'
    as _i923;
import '../../features/home/data/repository/repository/releases_repo_imp.dart'
    as _i235;
import '../../features/home/data/repository/repository/top_rated_repo_imp.dart'
    as _i328;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i642.DetailsApi>(() => _i642.DetailsApi());
    gh.factory<_i947.SimilarApi>(() => _i947.SimilarApi());
    gh.factory<_i236.PopularApi>(() => _i236.PopularApi());
    gh.factory<_i117.ReleasesApi>(() => _i117.ReleasesApi());
    gh.factory<_i362.TopRatedApi>(() => _i362.TopRatedApi());
    gh.factory<_i509.SearchApi>(() => _i509.SearchApi());
    gh.factory<_i462.SimilarDataSource>(
        () => _i700.SimilarDataSourceImp(gh<_i947.SimilarApi>()));
    gh.factory<_i102.ReleasesDataSource>(
        () => _i81.ReleasesDataSourceImp(gh<_i117.ReleasesApi>()));
    gh.factory<_i267.DetailsDataSource>(
        () => _i482.DetailsDataSourceImp(gh<_i642.DetailsApi>()));
    ...
    gh.factory<_i944.PopularRepo>(
        () => _i923.PopularRepoImp(gh<_i373.PopularDataSource>()));
